 ...
 * Use the {@link ParentChoresListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ParentChoresListFragment extends Fragment {
    ...
    public ParentChoresListFragment() {
        // Required empty public constructor
    }


    public static ParentChoresListFragment newInstance(String param1, String param2) {
        ParentChoresListFragment fragment = new ParentChoresListFragment();
        /**
         ...
         * @return A new instance of fragment ParentChoresListFragment.
         */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_parent_chores_list, container, false);

        recChores = view.findViewById(R.id.chore_recycler_view);
