...
public class VerificationFragment extends Fragment {
    ...
    String assignedTo, description, imageUrl, pointsWorth, status, title;

    public VerificationFragment() {

    }

    public VerificationFragment(String assignedTo, String description, String imageUrl, String pointsWorth, String status, String title) {
